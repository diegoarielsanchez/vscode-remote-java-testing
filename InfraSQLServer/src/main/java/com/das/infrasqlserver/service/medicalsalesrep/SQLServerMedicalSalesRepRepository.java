package com.das.infrasqlserver.service.medicalsalesrep;
...
@Service
public final class SQLServerMedicalSalesRepRepository implements MedicalSalesRepRepository {

    @Autowired
    private SQLServerMedicalSalesRepJpaRepository jpaRepository;
